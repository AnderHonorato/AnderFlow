...
export default function SentimentAnalyticsPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      // Analyze sentiments from metadata
      ...
      for (const item of allTexts) {
        ...
        const positiveWords = ['bom', 'otimo', 'excelente', 'obrigado', 'gostei', 'perfeito', 'rapido', 'feliz', 'satisfeito', 'incrivel']
        const negativeWords = ['ruim', 'pessimo', 'erro', 'atraso', 'problema', 'insatisfeito', 'lento', 'falha', 'bug', 'demora']
      ...
      // Word frequency in negative
      const negWords = new Map<string, number>()
      const stopWords = ['que', 'com', 'para', 'nao', 'uma', 'dos', 'das', 'mais', 'como', 'por']
      for (const item of allTexts) {
        const text = item.text.toLowerCase()
