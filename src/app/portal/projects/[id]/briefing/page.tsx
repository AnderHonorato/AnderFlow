            ...
            {q.options?.map(opt => {
              ...
              return (
                <button
                  key={opt}
                  type="button"
                  onClick={() => handleCheckbox(q.key, opt)}
        ...
        <Card>
          <CardContent className="p-8 text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--text-muted)] mt-1">A equipe irá analisar suas respostas e entrar em contato em breve.</p>
            </div>
      ...
      {sections.map((section, si) => (
        <Card key={si}>
          <CardContent className="p-4 space-y-3">
            <h3 className="text-sm font-medium text-[var(--text)] border-b border-[var(--border)] pb-2">
              {section.title}
            </h3>
