...
export function WelcomeOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4">
      <div className="bg-[var(--surface)] rounded-xl max-w-md w-full p-6 animate-scale-in space-y-5 text-center">
        ...
        <div>
          <h2 className="text-[17px] font-[500] tracking-[-0.015em] text-[var(--text)]">Bem-vindo(a), {name}!</h2>
          <p className="text-[13px] text-[var(--text-2)] mt-2 leading-relaxed">
            Sua conta foi criada com sucesso. Agora voce pode solicitar projetos,
            acompanhar o andamento em tempo real, enviar mensagens e muito mais.
          </p>
        </div>

        <div className="space-y-2 text-left bg-[var(--surface-hover)] rounded-lg p-3">
          {[
            'Solicite servicos e projetos personalizados',
